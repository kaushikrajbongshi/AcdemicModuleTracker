  ...
  const menu = [
    ...
    },
    {
      ...
      children: [
        ...
        { name: "All Course", href: "/dashboard/admin/allCourse", icon: List },
      ],
    },

    {
      ...
      children: [
        {
          name: "Add Faculty",
          href: "/dashboard/admin/addFaculty",
          icon: Plus,
        },
        {
          name: "Faculty Role",
          href: "/dashboard/admin/facultyRole",
          icon: UserStar,
        },
        {
          name: "Delete Faculty",
          href: "/dashboard/admin/deleteFaculty",
          icon: Trash2,
        },
      ],
    },
    {
      ...
      children: [
        {
          name: "Faculty Course",
          href: "/dashboard/admin/assignCourse",
          icon: Link,
        },
        {
          name: "Student Course",
          href: "/dashboard/admin/faculty-course",
          icon: Link,
        },
      ],
    },
    ...
    <div className="flex flex-col min-h-screen w-full bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 fixed top-0 left-0 right-0 z-30">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-linear-to-br from-indigo-600 to-indigo-700 rounded-lg flex items-center justify-center shadow-md">
